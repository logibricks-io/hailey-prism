...
const HELP_DOCS_PLACEHOLDER = '"__PRISM_EMBEDDED_HELP_DOCS__"';
...
const skillSourceDir = join(repoRoot, "skills", "prism-browser");
const bundledSkillDir = join(outDir, "prism-browser");
...
try {
  ...
  if (error?.code === "EEXIST") {
    throw new Error("another prism-browser-v2 build is already running");
  }
  throw error;
}
...
try {
  ...
  await rm(join(root, "prism-browser.js"), { force: true });
