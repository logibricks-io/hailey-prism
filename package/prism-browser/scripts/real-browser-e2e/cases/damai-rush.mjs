...
export const damaiRushCase = caseBody(`
  ...
  assertEqual(
    await page.getByRole("heading", { name: "PRISM STARLIGHT TOUR" }).innerText(),
    "PRISM STARLIGHT TOUR",
  ...
  await page.getByLabel("下单账号").fill("Prism E2E Agent");
  ...
  await waitForJsCondition(
    'document.querySelector("#order-result")?.textContent.includes("PRISM-0001")',
