export function helperSurfaceCase() {
  return `
    ...
    assertEqual(typeof page.getByAltText("Prism fixture logo").count, "function", "getByAltText returns a locator");
    ...
    assertEqual(await page.getByAltText("Prism fixture logo").count(), 1, "getByAltText finds the image");
