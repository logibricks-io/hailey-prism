export function navigationCase() {
  return `
    ...
    assertEqual(info.title, "prism-lite helper e2e", "pageInfo reads fixture title");
    ...
    assertEqual(secondaryTitleViaTarget, "prism-lite secondary", "js evaluates against explicit target id");
    const homeTitleViaTarget = await page.evaluate("return document.title", home.targetId);
    assertEqual(homeTitleViaTarget, "prism-lite helper e2e", "js target id leaves current tab independent");
    ...
    assertEqual(secondaryInfo.title, "prism-lite secondary", "switchTab selects secondary tab");
    ...
    assertEqual(navInfo.title, "prism-lite nav target", "goto navigates current tab");
