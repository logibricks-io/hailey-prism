...
export const workflowCases = [
  {
    ...
    body: homeCase(`
      ...
      assertEqual(homeInfo.title, "prism-lite helper e2e", "workflow: home title before navigation");
      ...
      assertEqual(navInfo.title, "prism-lite nav target", "workflow: page title changes after navigation");
      ...
      assertEqual(secTitle, "prism-lite secondary", "workflow: secondary tab title is correct");
      ...
      assertEqual(navTitleAfterSwitch, "prism-lite nav target", "workflow: nav-target title persists across tab switches");
      ...
      assertEqual(backHomeInfo.title, "prism-lite helper e2e", "workflow: home title restored after multi-tab navigation");
