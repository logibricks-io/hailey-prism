    ...
    if (url.pathname === "/healthz") {
      ...
      res.end(
        JSON.stringify({
          ok: true,
          taskName,
          fixture: "prism-browser-real-e2e",
          now: Date.now(),
        }),
      );
      return;
...
function pageHtml(kind) {
  const title =
    kind === "nav-target"
      ? "prism-lite nav target"
      : kind === "secondary"
        ? "prism-lite secondary"
        : kind === "frame"
          ? "prism-lite iframe"
          : "prism-lite helper e2e";
  const heading =
    kind === "nav-target"
      ? "Navigation target"
      : kind === "secondary"
    ...
    <main>
      ...
      <div class="card-row">
        ...
        <div>
          ...
          <div class="card">
            <img id="alt-logo" alt="Prism fixture logo" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" style="width:1px;height:1px;opacity:0" />
