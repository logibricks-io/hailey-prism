...
export function prismSource(body, context) {
  const {
    taskName,
    baseUrl,
    artifactDir,
  ...
  return `
    ...
    const verboseAssertions =
      process.env.PRISM_BROWSER_REAL_E2E_VERBOSE_ASSERTIONS === "1" ||
      process.env.PRISM_BROWSER_REAL_E2E_VERBOSE_ASSERTIONS === "true";
