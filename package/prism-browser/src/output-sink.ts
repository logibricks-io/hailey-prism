 ...
 * straight through. When a hard-stop error is born (see `buildPrismError`) we record its
 ...
 * "prism lite update available" hint reads as a footer after the command's own output.
 *
