...
export const HELP = `prism-browser

Read the prism-browser skill for the default workflow and examples.
...
export async function executionContext() {
  ...
  // that installPrismSdk() exposes in the browser runtime, so the CLI and SDK paths
